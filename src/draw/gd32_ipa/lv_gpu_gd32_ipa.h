...
void lv_draw_gd32_ipa_ctx_init(struct _lv_disp_t * drv, lv_layer_t * layer);

void lv_draw_gd32_ipa_ctx_deinit(struct _lv_disp_t * drv, lv_layer_t * layer);

void lv_draw_gd32_ipa_blend(lv_layer_t * layer, const lv_draw_sw_blend_dsc_t * dsc);

void lv_draw_gd32_ipa_buffer_copy(lv_layer_t * layer,
